//I increased the movement speed and changed the set color and changed others various things
#include <conio.h>
#include <vector>
#include <graphics.h>
#include <dos.h>       // libs
...
void graphic() // the graphic
{
	...
	floodfill(fruitx + 5, fruity + 5, RED);
// I changed the color of snake and The text "Score"
	setcolor(BLUE);
	...
	for (int lenght = lenghtmax; lenght > 0; lenght--)
	{
		...
		floodfill(snakex[i] + 5, snakey[i] + 5, BLUE);
		i--;
	}
